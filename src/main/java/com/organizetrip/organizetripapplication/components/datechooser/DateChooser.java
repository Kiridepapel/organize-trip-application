package com.organizetrip.organizetripapplication.components.datechooser;

import com.formdev.flatlaf.FlatClientProperties;
import com.formdev.flatlaf.extras.FlatSVGIcon;
import com.formdev.flatlaf.util.UIScale;
import com.organizetrip.organizetripapplication.components.datechooser.layout.CellLayout;
import com.organizetrip.organizetripapplication.components.datechooser.layout.HeaderLayout;
import com.organizetrip.organizetripapplication.components.datechooser.listener.DateChooserAction;
import com.organizetrip.organizetripapplication.components.datechooser.listener.DateChooserListener;
import com.organizetrip.organizetripapplication.components.datechooser.render.DateChooserRender;
import com.organizetrip.organizetripapplication.components.datechooser.render.DefaultDateChooserRender;
...
public class DateChooser extends JPanel {
    ...
    public DateChooser(SimpleDateFormat dateFormat, String btwChar) {
        this.dateFormat = dateFormat;
        this.betweenCharacter = btwChar;
        init();
    }
    ...
    private String[] getListDay() {
        ...
        if (days == null) {
            ...
            // en español
            return new String[]{"Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"};
        } else {
            return days;
        }
    }
    ...
    private void createHeader() {
        ...
        panelHeader.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:if($DateChooser.background,$DateChooser.background,$Panel.background)");
        JButton cmdBack = new JButton(new FlatSVGIcon("assets/svgs/arrowCollapse.svg"));
        JButton cmdNext = new JButton(new FlatSVGIcon("assets/svgs/arrowExpand.svg"));
